...
view.insertRow.call(view,_596,_597.login,_597.row);
_598.push(_597.row);
...
var tr=opts.finder.getTr(_5b7,(_5b8.login!=undefined?_5b8.login:_5b8.id));
if(!tr.length){
return;
}
...
return jq.each(function(){
var opts=$.data(this,"datagrid").options;
opts.view.updateRow.call(opts.view,this,_622.login,_622.row);
});
