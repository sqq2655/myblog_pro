...
vjs.Component.prototype.dimension = function(widthOrHeight, num, skipListeners){
  if (num !== undefined) {
    ...
    if ((''+num).indexOf('%') !== -1 || (''+num).indexOf('px') !== -1) {
      this.el_.style2[widthOrHeight] = num;
    } else if (num === 'auto') {
      this.el_.style2[widthOrHeight] = '';
    } else {
      this.el_.style2[widthOrHeight] = num+'px';
    }
  ...
  var val = this.el_.style2[widthOrHeight];
...
vjs.Slider.prototype.update = function(){
  ...
  if (handle) {
    ...
    handle.el().style2.left = vjs.round(adjustedProgress * 100, 2) + '%';
  }

  // Set the new bar width
  bar.el().style2.width = vjs.round(barProgress * 100, 2) + '%';
};
...
vjs.LoadProgressBar.prototype.update = function(){
  if (this.el_.style2) { this.el_.style2.width = vjs.round(this.player_.bufferedPercent() * 100, 2) + '%'; }
};
...
vjs.PosterImage.prototype.createEl = function(){
  ...
  if (poster) {
    if ('backgroundSize' in el.style2) {
      el.style2.backgroundImage = 'url("' + poster + '")';
    } else {
...
vjs.TextTrack.prototype.adjustFontSize = function(){
    if (this.player_.isFullScreen) {
        ...
        this.el_.style2.fontSize = screen.width / this.player_.width() * 1.4 * 100 + '%';
    } else {
        // Change the font size of the text track back to its original non-fullscreen size
        this.el_.style2.fontSize = '';
    }
};
