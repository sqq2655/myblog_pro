...
(function(window) {
    ...
    if (flashBridge) {
      ...
      if (htmlBridge) {
        if (_flashState.pluginType === "activex" && "readyState" in flashBridge) {
          flashBridge.style2.display = "none";
  ...
  ZeroClipboard.deactivate = function() {
    ...
    if (htmlBridge) {
      ...
      htmlBridge.style2.left = "0px";
      htmlBridge.style2.top = "-9999px";
      _setSize(1, 1);
    }
    if (_currentElement) {
      _removeClass(_currentElement, _globalConfig.hoverClass);
  ...
  var _reposition = function() {
    if (_currentElement) {
      ...
      var htmlBridge = _getHtmlBridge(_flashState.bridge);
      if (htmlBridge) {
        htmlBridge.style2.top = pos.top + "px";
        htmlBridge.style2.left = pos.left + "px";
        htmlBridge.style2.width = pos.width + "px";
        htmlBridge.style2.height = pos.height + "px";
        htmlBridge.style2.zIndex = pos.zIndex + 1;
      }
  ...
  var _setSize = function(width, height) {
    var htmlBridge = _getHtmlBridge(_flashState.bridge);
    if (htmlBridge) {
      htmlBridge.style2.width = width + "px";
      htmlBridge.style2.height = height + "px";
    }
  };
